...
export function DynamicIsland() {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[100000] flex justify-center w-full max-w-[400px] pointer-events-none">
      <AnimatePresence mode="wait">
        {islandMessage && (
          <motion.div
            ...
            className="bg-black/90 backdrop-blur-2xl text-white px-8 py-4 rounded-[32px] shadow-[0_25px_60px_rgba(0,0,0,0.6),0_0_25px_rgba(107,92,255,0.4)] flex items-center gap-4 border border-white/20 pointer-events-auto ring-1 ring-white/10"
          >
